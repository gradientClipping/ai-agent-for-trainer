...
# HARDCODED API KEY
# ─────────────────────────────────────────────
HARDCODED_API_KEY = "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"
...
def main():
    ...
    # ── Sidebar  (no API key input — it's hardcoded) ──
    with st.sidebar:
        st.markdown(
